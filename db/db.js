...
const datos = [
    {
        ...
        descripcion: 'El epítome del lujo y la tecnología automotriz.',
        comentarios: [
            {
    ...
    },
    {
        ...
        nombre: 'Audi A8',
        descripcion: 'Elegancia y rendimiento en su máxima expresión.',
        comentarios: [
            {
    ...
    },
    {
        ...
        nombre: 'BMW Serie 7',
        descripcion: 'Un sedán de lujo que redefine el confort y la potencia.',
        comentarios: [
            {
                usuario: '@bmw_fanatic',
    ...
    },
    {
        ...
        nombre: 'McLaren 720S',
        descripcion: 'Innovación y rendimiento en un superdeportivo impresionante.',
        comentarios: [
            {
                usuario: '@speed_demon',
    ...
    },
        {
            ...
            descripcion: 'El SUV de lujo definitivo, con una presencia imponente y comodidad insuperable.',
            comentarios: [
                {
        ...
        },
        {
            ...
            descripcion: 'Lujo, elegancia y rendimiento se unen en este sedán excepcional.',
            comentarios: [
                {
        ...
        },
        {
            ...
            nombre: 'Bugatti Divo',
            descripcion: 'Diseñado para dominar las curvas y ofrecer una experiencia de conducción incomparable.',
            comentarios: [
                {
        ...
        },
        {
            ...
            descripcion: 'Un icónico deportivo con tecnología de vanguardia y un rendimiento excepcional.',
            comentarios: [
                {
        ...
        },
        {
            ...
            descripcion: 'Un coupé elegante y potente que fusiona la artesanía británica con la tecnología de vanguardia.',
            comentarios: [
                {
        ...
        },
        {
            ...
            nombre: 'Lexus LC 500',
            descripcion: 'Un gran turismo de lujo con un diseño cautivador y un rendimiento emocionante.',
            comentarios: [
                {
